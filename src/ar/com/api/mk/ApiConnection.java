...
import ar.com.api.mk.impl.ApiConnectionImpl;
...
public abstract class ApiConnection implements AutoCloseable {
     ...
     * @throws ar.com.api.mk.MikrotikApiException Thrown if there is a problem connecting
     * @since 2.1
     */
   ...
   public static ApiConnection connect(String host) throws MikrotikApiException {
    ...
    /**
     * @throws ar.com.api.mk.MikrotikApiException
     ...
     * @throws ar.com.api.mk.MikrotikApiException Thrown if there is a problem canceling the command */
     ...
     * @throws ar.com.api.mk.ApiConnectionException Thrown if there is a problem closing the connection.
     * @since 2.2
    */
    @Override
